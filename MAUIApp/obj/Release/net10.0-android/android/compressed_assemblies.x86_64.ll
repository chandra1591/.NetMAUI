...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [130 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12290960; uint32_t buffer_offset
	}, ; 127: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22048, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12461968; uint32_t buffer_offset
	}, ; 128: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2024960, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12484016; uint32_t buffer_offset
	} ; 129: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14508976, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14508976 x i8] zeroinitializer, align 16
